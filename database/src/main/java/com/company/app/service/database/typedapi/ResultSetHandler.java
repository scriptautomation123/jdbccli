 ...
 *
 * <p>
 * <strong>Architectural Pattern:</strong> ResultSetHandlers are cached by the
 * {@link
 * DefaultResultSetHandlerFactory} based on query structure + bean type. Once
 * created, they can
 * efficiently convert multiple rows without repeated reflection or type handler
 * lookup.
 *
 * <p>
 ...
 * </pre>
 *
 * First execution builds and caches the handler chain; subsequent executions
 * hit cache at factory
...
public interface ResultSetHandler<T> {
  ...
  /**
   * Handles multiple rows from the ResultSet and returns a list of mapped
   * objects. The ResultSet
