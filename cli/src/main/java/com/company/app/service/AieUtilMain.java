...
/**
 * Main CLI application that registers all available commands. Provides a unified entry point for
 * all aieutil operations.
 */
@Command(
    name = "aieutil",
    ...
    version = "1.0.0",
    subcommands = {ExecProcedureCmd.class, ExecSqlCmd.class})
